...
6. `lotus-idea` RFC-0002 Slice 16/17 may consume the source-safe producer proof generated by
   ...
   requests for `PB_SG_GLOBAL_BAL_001`, `BMK_PB_GLOBAL_BALANCED_60_40`, and `2026-04-10`, clears
   only Risk source-proof blockers, and does not transfer risk methodology, data-mesh,
   Gateway/Workbench, client-publication, deployment, production, or supported-feature authority.
