...
| `GET /metadata` | Operational | service/version/rounding/build provenance metadata | operational | operational | internal constants + build/runtime provenance environment | Local unpublished builds report an explicit unavailable image digest until registry/deployment metadata supplies the published digest |
| `GET /version` | Operational | same service/version/rounding/build provenance metadata as `/metadata` | operational | operational | internal constants + build/runtime provenance environment | Local unpublished builds report an explicit unavailable image digest until registry/deployment metadata supplies the published digest |
