...
| `POST /analytics/risk/historical-attribution` | Domain analytics | historical risk and active-risk attribution decomposition | none (RFC-0006 proposed) | stateless + stateful + simulation | planned stateful sourcing via lotus-performance portfolio/benchmark/exposure history contracts | lotus-report, lotus-gateway, PB/WM advisory workflows | planned (RFC-0006) |
