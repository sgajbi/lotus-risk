  ...
  - `metrics` map:
    - each metric:
      ...
      - `details?: object`
        ...
        - metric-specific detail payload (for example drawdown metadata, Sharpe mean/excess return and volatility, Sortino downside context, VaR method/confidence/horizon/expected shortfall)
