...
| Idea opportunity producer proof | `make idea-opportunity-runtime-evidence` | source-safe stateful producer evidence for Idea RFC-0002 Slice 16/17 | binds to `PB_SG_GLOBAL_BAL_001`, `BMK_PB_GLOBAL_BALANCED_60_40`, `2026-04-10`, and RFC-0076 canonical contract provenance; clears only Risk source-proof blockers; no Idea persistence, data-mesh, Gateway/Workbench, client-publication, deployment, production, or supported-feature certification |
