...
| Idea opportunity producer proof | `make idea-opportunity-runtime-evidence` | source-safe producer evidence for Idea RFC-0002 Slice 16/17 | clears only Risk source-proof blockers; no Idea persistence, data-mesh, Gateway/Workbench, client-publication, deployment, production, or supported-feature certification |
