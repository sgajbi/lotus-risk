...
- Python source files under `src/`: 182
...
| src/app/integrations/lotus_performance_client.py | 326 | 11128 |
...
---------------------------------------------------------------------------------------------------
TOTAL                                                    5168     80    978     79    97%

143 files skipped due to complete coverage.
474 passed in 7.74s
```
