...
- Python source files under `src/`: 88
...
| src/app/services/concentration/resolvers.py | 513 | 17524 |
...
--------------------------------------------------------------------------------------------------
TOTAL                                                   4638     84    986     85    97%

52 files skipped due to complete coverage.
447 passed in 10.00s
```
