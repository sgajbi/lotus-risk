...
- Git commit: `b71872c954c61662b7ee220220fd0b33bcd168b9`
...
| Path | Lines | Bytes |
| --- | --- | --- |
| src/app/enterprise_readiness.py | 245 | 8247 |
...
--------------------------------------------------------------------------------------------------------
TOTAL                                                         6324     91   1054     73    98%

198 files skipped due to complete coverage.
590 passed in 14.93s
```
