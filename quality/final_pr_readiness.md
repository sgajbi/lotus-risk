...
3. The latest quality baseline collects `452` tests across `91` Python test files.
...
1. Several service and contract modules remain large enough to deserve later cohesive extraction:
   `attribution.py` and targeted concentration/rolling/risk/drawdown response fragments.
...
2. The latest generated baseline records `452` collected tests and `97%` total coverage.
