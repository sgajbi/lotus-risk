...
| --- | --- | --- |
| API modularity | `src/app/main.py` is 980 lines | Split app factory, routers, error metadata, and dependencies |
...
| Tests | 77 Python test files; 369 unit tests collect | Add route-boundary and governance regression tests per slice |
