...
| 2 | Largest remaining function | _calculate_period_result has 62 lines | Extract focused helpers around the next service hotspot while preserving behavior with characterization tests |
