...
| 2 | Largest remaining function | evaluate_regime_scenario_pack has 60 lines | Extract focused helpers around the next service hotspot while preserving behavior with characterization tests |
