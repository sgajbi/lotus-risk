...
| --- | --- | --- | --- |
| 1 | Service module size | Largest remaining source modules include `attribution_mode_adapter.py` and `concentration/resolvers.py`; attribution orchestration and rolling stateful input resolution have been split from public adapters | Continue extracting cohesive orchestration, response-building, and dependency-resolution helpers with characterization tests |
