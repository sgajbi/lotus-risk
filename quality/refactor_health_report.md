...
| 2 | Largest remaining function | _build_attribution_set has 69 lines | Extract focused helpers around the next service hotspot while preserving behavior with characterization tests |
