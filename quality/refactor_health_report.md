...
| --- | --- | --- | --- |
| 1 | Service module size | Largest remaining source modules include `concentration/resolvers.py`, `drawdown_engine.py`, `attribution_engine.py`, and `rolling_mode_adapter.py` | Continue extracting cohesive orchestration, response-building, and dependency-resolution helpers with characterization tests |
