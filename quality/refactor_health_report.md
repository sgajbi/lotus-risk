...
| 2 | Largest remaining function | get_returns_series has 56 lines | Extract focused helpers around the next service hotspot while preserving behavior with characterization tests |
