...
| 2 | Largest remaining function | _resolve_stateful_rolling_inputs has 58 lines | Extract focused helpers around the next service hotspot while preserving behavior with characterization tests |
