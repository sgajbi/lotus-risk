...
| 2 | Largest remaining function | calculate_historical_attribution has 139 lines | Extract smaller metric helpers while preserving behavior with characterization tests |
