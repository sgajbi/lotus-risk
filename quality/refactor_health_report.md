...
| 2 | Largest remaining function | _poll_returns_series_result has 93 lines | Extract focused helpers around the next service hotspot while preserving behavior with characterization tests |
