...
| 2 | Largest remaining function | integration_capabilities has 93 lines | Extract focused helpers around the next service hotspot while preserving behavior with characterization tests |
