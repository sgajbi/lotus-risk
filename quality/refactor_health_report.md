...
| --- | --- | --- | --- |
| 1 | Service module size | Largest remaining source modules include `drawdown_engine.py`, `attribution_engine.py`, `rolling_mode_adapter.py`, and `attribution_mode_adapter.py` | Continue extracting cohesive orchestration, response-building, and dependency-resolution helpers with characterization tests |
