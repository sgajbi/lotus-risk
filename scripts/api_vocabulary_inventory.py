...
DEFAULT_OUTPUT = (
    PROJECT_ROOT / "docs" / "standards" / "api-vocabulary" / "lotus-risk-api-vocabulary.v1.json"
)
...
def _fallback_description(name: str) -> str:
    ...
    return f"Canonical {readable} used by lotus-risk APIs."
...
def main() -> int:
    parser = ArgumentParser(description="Generate and validate lotus-risk API vocabulary inventory")
