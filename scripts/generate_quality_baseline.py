...
| --- | --- | --- |
| Import-linter | `.importlinter` contracts exist; local baseline currently records unavailable console command when missing from PATH | Enforce once CI environment proves command availability |
...
| Docstring coverage | `interrogate` is declared as dev tooling | Add report-only evidence, then targeted thresholds |
