        ...
        markdown_table(
            ...
            [
                ...
                (
                    ...
                    "Concentration, rolling, risk, and drawdown request/response contracts are split; `attribution.py` remains the largest prominent contract source file",
