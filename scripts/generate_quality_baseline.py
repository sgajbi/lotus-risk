        ...
        markdown_table(
            ...
            [
                ...
                (
                    ...
                    "Concentration, rolling, and risk request/response contracts are split; `drawdown.py` and `attribution.py` remain prominent source files",
