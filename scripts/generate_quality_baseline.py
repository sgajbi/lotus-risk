        ...
        markdown_table(
            ...
            [
                (
                    1,
                    "Service module size",
                    "Largest remaining source module hotspots include `concentration/resolvers.py`; attribution and rolling public adapters have been split from stateful input and exposure-resolution helpers",
                ...
                (
                    ...
                    "Contract modules are improved but `concentration.py`, `rolling.py`, `risk.py`, and `drawdown.py` remain prominent source files",
                    "Split reusable metadata or nested contract fragments only where it improves reviewability",
                ),
                (
                    3,
