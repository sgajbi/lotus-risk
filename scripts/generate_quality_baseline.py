        ...
        markdown_table(
            ...
            [
                (
                    1,
                    "Service module size",
                    "Largest remaining source modules include `rolling_mode_adapter.py`, `attribution_mode_adapter.py`, and `concentration/resolvers.py`; attribution orchestration has been split from decomposition math",
