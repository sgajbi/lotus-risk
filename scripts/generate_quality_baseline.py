        ...
        markdown_table(
            ...
            [
                ...
                (
                    ...
                    "Concentration, rolling, risk, drawdown, and attribution request/response contracts are split; concentration and rolling response models are further split into metric/detail and top-level response modules; drawdown response remains the largest response contract-size pressure",
